...
function showForm(formId) {
    const sections = ['login-form', 'signup', 'dashboard', 'game-mode', 'profile', 'settings', 'editprofile', 'friends', 'tournament-registration'];
    sections.forEach(id => {
...
document.addEventListener('DOMContentLoaded', async () => {
    const userIconGameMode = document.querySelector('#game-mode .sidebar #settings-icon');
...
document.addEventListener('DOMContentLoaded', async () => {
    const userIconGameMode = document.querySelector('#game-mode .sidebar #grid-icon');
    const userIconSettings = document.querySelector('#dashboard .sidebar #logout-icon');
...
document.addEventListener('DOMContentLoaded', async () => {
    const userIconGameMode = document.querySelector('#game-mode .sidebar #logout-icon');
    const userIconSettings = document.querySelector('#editprofile .sidebar #mode-game-icon');
...
document.addEventListener('DOMContentLoaded', async () => {
    const userIconGameMode = document.querySelector('#game-mode .sidebar #friends-icon');
